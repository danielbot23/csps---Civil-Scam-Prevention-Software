...
CSPS goes beyond generic spam filters by analyzing the specific, documented signatures of active fraud patterns and generating a probabilistic confidence score alongside how to address them .

## Overview

Government and corporate impersonation scams cost victims hundreds of millions annually. Modern attackers utilize real public data paired with urgent, non-standard payment demands. Generic spam checkers often miss these because the text appears highly localized and contextually accurate. CSPS acts as an automated tool to combat these sophisticated attacks.
...
1. **Start the Software:**
   Open `index.html` in your preferred web browser to access the dashboard.
